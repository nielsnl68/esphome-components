...
public:
  ...
  void set_backlight_pin(GPIOPin *backlight) {
    this->backlight_pin_ = backlight;
  }
  void set_palette(const uint8_t *palette) { this->palette_ = palette; }
  void set_buffer_color_mode(ILI9XXXColorMode color_mode) {
    this->buffer_color_mode_ = color_mode;
  }
  ...
  void send_command(uint8_t command_byte, const uint8_t *data_bytes,
