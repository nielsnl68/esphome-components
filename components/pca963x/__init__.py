...
from esphome.const import CONF_ID, CONF_INVERTED, CONF_MODEL

DEPENDENCIES = ['i2c']
MULTI_CONF = True

pca963x_ns = cg.esphome_ns.namespace('pca963x')
...
PCA963xOutput = pca963x_ns.class_('PCA963xOutput', cg.Component, i2c.I2CDevice)
